...
image::https://img.shields.io/badge/status-draft-red.svg[float="left"] image::https://img.shields.io/swagger/valid/2.0/https/openchatbot.io/swagger/swagger.yaml.svg?style=flat[float="left"]
