...
WARNING: This specification is still a work in progress version and not yet published as an official release.
...
to define a common standard specification for communication with any conversational agent (text and/or voice).
